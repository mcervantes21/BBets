...
The 95% confidence interval shows that the values range from `r sortProfit[25]` to `r sortProfit[975]` . However if you run that code again, the values will continue to change.
